    ...
    >
     ...
     <h2 className="max-w-2xl text-5xl font-medium text-center text-balance md:text-7xl">
      ...
      <div className="max-w-md mx-auto mt-6 text-center text-balance text-slate-300">
        <PrismicRichText field={slice.primary.bod} />
      </div>

      <div className="grid gap-16 mt-20">
        {caseStudies.map((caseStudy, index) =>(
          caseStudy && (
            <div key={caseStudy.id} className="relative grid gap-4 transition-opacity duration-300 opacity-85 hover:cursor-pointer hover:opacity-100 md:grid-cols-2 md:gap-8 lg:grid-cols-3">
